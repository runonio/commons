...
package io.runon.jdbc.connection;
...
public class ApplicationConnectionPool {
    ...
    public void setConfigConnectionInfo(){
        ...
        // dataSource를 외부에서 설정한것을 사용할 때
        if(!Config.getBoolean("seomse.jdbc.datasource.flag" ,true)){
            return;
        }
...
//        }
    ...
    /**
     * DataSource 설정
     * 외부에서 생성한 DataSource 를 새로 생성하지 않고 이용할때 활용
     * seomse.jdbc.datasource.flag 설정값이 false 여야 증복 생성을 하지 않는다
     *
     * @param dataSource 외부에서 생성한 DataSource
     */
